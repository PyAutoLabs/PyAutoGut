...
- workspace-pr: https://github.com/PyAutoLabs/autolens_profiling/pull/108
- summary: Phase 1 established the reusable numerical-hazard profiling framework, typed risk measurements, reachability and stable-anchor records, regression checking, five persisted findings and the consumer-facing hazard index. PR #108 passed 62 local tests, formatting/lint, README generation, smoke and full NumPy/JAX checks; GitHub lint was green before merge at d20267e. Phase 2 remains a separate prompt and task.
