...
- trap for later: `for-the-badge` uppercases the label ("PYAUTOSCIENTIST GITHUB") — that is baked into the style, not an encoding bug. The human chose branded casing over the button look same-day: follow-up sweep switched all fourteen badge URLs to `style=flat-square` (PyAutoMind 1fde3f13, PyAutoBrain c6af996, PyAutoHeart 003d7ba, PyAutoHands b64176d, PyAutoGut 87322b9, PyAutoNerves 14887c3, PyAutoMemory b32ad3e).
