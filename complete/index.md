...
- [assistant-output-folder-pointer](2026/07/assistant-output-folder-pointer.md) — All three assistant cells now tell novice/teacher-mode users where an active fit writes output and point at th…
