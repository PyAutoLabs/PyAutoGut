...
<!-- generated by `pyauto-brain intake dashboard --apply` on 2026-08-22 — regenerate, do not hand-edit -->
...
<details><summary>📋 <a href="draft/bug/autoarray/convert_shape_native_int_not_widened_to_tuple.md"><code>shape_native</code> given as an <code>np.integer</code> is never widened to a</a> — autoarray · small · supervised · low</summary>

```
/start_dev draft/bug/autoarray/convert_shape_native_int_not_widened_to_tuple.md
```

</details>

<details><summary>📋 <a href="draft/bug/autoarray/pixel_scales_tuple_entries_not_normalised.md"><code>pixel_scales</code> tuple entries are not normalised, so the scalar and</a> — autoarray · small · supervised · low</summary>

```
/start_dev draft/bug/autoarray/pixel_scales_tuple_entries_not_normalised.md
```
