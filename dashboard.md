...
- [MultiStartGradient value-NaN and gradient-NaN step diagnostics](active/multistart_gradient_nan_step_diagnostics.md) — [issue #1472](https://github.com/PyAutoLabs/PyAutoFit/issues/1472) — library-dev — worktree created, ready for edits
