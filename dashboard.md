...
<!-- generated by `pyauto-brain intake dashboard --apply` on 2026-08-23 — regenerate, do not hand-edit -->
...
<details><summary>📋 <a href="draft/bug/workspaces/bug_fix_the_tracer_fits_existence_guard.md">Bug: fix the tracer.fits existence guard in autolens_workspace imaging modeling.py</a> — workspaces · small · safe · normal</summary>
...
<details><summary>📋 <a href="draft/bug/autoarray/numba_kernel_shift_axes_swapped.md">Numba PSF gathers derive the y/x kernel shifts from the wrong kernel…</a> — autoarray · low · supervised · medium</summary>
...
<details><summary>📋 <a href="draft/bug/autolens_workspace/script_local_pixel_scale_vs_dataset_pixel_scales.md">Scripts derive geometry from a hardcoded pixel_scale while the dataset carries…</a> — autolens_workspace · small · supervised · normal</summary>
...
<details><summary>📋 <a href="draft/bug/autolens_workspace_developer/committed_datasets_do_not_reproduce.md">autolens_workspace_developer committed datasets do not reproduce from their own scripts</a> — autolens_workspace_developer · medium · supervised · normal</summary>

```
/start_dev draft/bug/autolens_workspace_developer/committed_datasets_do_not_reproduce.md
```
...
<details><summary>📋 <a href="draft/bug/assistants/wiki_currency_red_on_main.md">Both assistant repos have a red wiki-currency check on main</a> — assistants · low · supervised · normal</summary>

```
/start_dev draft/bug/assistants/wiki_currency_red_on_main.md
```
...
<details><summary>📋 <a href="draft/docs/autogalaxy_workspace/markdown_regeneration_pynufft_prose.md">Regenerate autogalaxy_workspace markdown/ so three curated pages drop the pynufft prose</a> — autogalaxy_workspace · small · supervised · normal</summary>

```
/start_dev draft/docs/autogalaxy_workspace/markdown_regeneration_pynufft_prose.md
```
