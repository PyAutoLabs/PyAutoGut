...
<details><summary>📋 <a href="draft/bug/pyautonerves/fits_header_dict_comment_is_a_literal_list.md">Every header_dict FITS card carries the literal comment text ['']</a> — pyautonerves · small · supervised · low</summary>

```
/start_dev draft/bug/pyautonerves/fits_header_dict_comment_is_a_literal_list.md
```
