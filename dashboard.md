...
- [Per-parameter step scaling for the gradient searches — treat the](draft/feature/autofit/per_parameter_step_scaling.md) — autofit · medium · supervised · high
...
- [Clipper: demonstrate and validate on the profiling search cells](active/clipper_validation_campaign.md) — [issue #131](https://github.com/PyAutoLabs/autolens_profiling/issues/131) — RESULTS IN 2026-08-16, both branches pushed, PRs not yet opened. VERDICT: recommend AGAINST flipping the clipper default, and…
