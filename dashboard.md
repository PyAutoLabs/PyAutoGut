...
<details><summary>📋 <a href="active/imaging_ci_heritage_sweep.md">Top-level <code>imaging_ci/</code> is pre-resurrection heritage the legacy sweep missed</a> — <a href="https://github.com/PyAutoLabs/autocti_workspace_test/issues/19">issue #19</a> — issued 2026-08-24 — workspace-dev</summary>

```
/start_dev active/imaging_ci_heritage_sweep.md
```
...
| 2026-08-24 | issued | <a href="active/imaging_ci_heritage_sweep.md">Top-level <code>imaging_ci/</code> is pre-resurrection heritage the legacy sweep…</a> |
