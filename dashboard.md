...
<!-- generated by `pyauto-brain intake dashboard --apply` on 2026-08-17 — regenerate, do not hand-edit -->
...
- [Clipper: demonstrate and validate on the profiling search cells](active/clipper_validation_campaign.md) — [issue #131](https://github.com/PyAutoLabs/autolens_profiling/issues/131) — AWAITING MERGE 2026-08-17 — both PRs now open: PyAutoFit#1482 (`seed`, `alive_history`, `reset_momentum_on_clip`) and…
...
- [Per-parameter step scaling for the gradient searches — treat the](active/per_parameter_step_scaling.md) — [issue #1483](https://github.com/PyAutoLabs/PyAutoFit/issues/1483) — LIBRARY SHIPPED to branch 2026-08-17, MEASUREMENT RUNNING. PyAutoFit `4f629ff` (scaler + tests + model.info block +…
