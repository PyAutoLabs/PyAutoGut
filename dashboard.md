...
<details><summary>📋 <a href="active/run_smoke_copy_drift.md">run_smoke.py: three runner variants across 10 repos, no sync mechanism</a> — <a href="https://github.com/PyAutoLabs/PyAutoHands/issues/260">issue #260</a> — issued 2026-08-24 — library-dev</summary>

```
/start_dev active/run_smoke_copy_drift.md
```
...
| Date | Event | Task |
|------|-------|------|
| 2026-08-24 | issued | <a href="active/run_smoke_copy_drift.md">run_smoke.py: three runner variants across 10 repos, no sync mechanism</a> |
