...
<details><summary>📋 <a href="draft/maintenance/ci/claude_session_python_311_default.md">Claude web/mobile session containers default to Python 3.11 — below the organism's…</a> — ci · medium · supervised · normal</summary>

```
/start_dev draft/maintenance/ci/claude_session_python_311_default.md
```
