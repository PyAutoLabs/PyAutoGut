...
<!-- generated by `pyauto-brain intake dashboard --apply` on 2026-08-15 — regenerate, do not hand-edit -->
...
- [MultiStartGradient value-NaN and gradient-NaN step diagnostics](active/multistart_gradient_nan_step_diagnostics.md) — [issue #1472](https://github.com/PyAutoLabs/PyAutoFit/issues/1472) — library-shipped, awaiting-merge — PRs open, smoke clean (3 autolens_test failures reproduced identically on main)
