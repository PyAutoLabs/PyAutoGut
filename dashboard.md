...
<details><summary>📋 <a href="draft/bug/ci/jax_vmap_jit_compile_stall.md">Intermittent XLA compile stall in JAX vmap likelihood scripts —</a> — ci · medium · supervised · high</summary>
...
<details><summary>📋 <a href="draft/maintenance/ci/backport_per_script_timeout.md">Backport the per-script timeout: 6 of 10 smoke runners have</a> — ci · medium · supervised · high</summary>

```
/start_dev draft/maintenance/ci/backport_per_script_timeout.md
```
...
| Date | Event | Task |
|------|-------|------|
| 2026-08-23 | filed | <a href="draft/bug/ci/jax_vmap_jit_compile_stall.md">Intermittent XLA compile stall in JAX vmap likelihood scripts —</a> |
...
| 2026-08-23 | filed | <a href="draft/maintenance/ci/backport_per_script_timeout.md">Backport the per-script timeout: 6 of 10 smoke runners have</a> |
