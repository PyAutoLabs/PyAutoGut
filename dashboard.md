...
- [Per-parameter step scaling for the gradient searches — treat the](active/per_parameter_step_scaling.md) — [issue #1483](https://github.com/PyAutoLabs/PyAutoFit/issues/1483) — library-dev
