...
<details><summary>📋 <a href="active/pynufft_removal_downstream_residue_phase_1_developer_break.md">Phase 1: fix the pynufft AttributeError breaking all jax_profiling dataset</a> — <a href="https://github.com/PyAutoLabs/autolens_workspace_developer/issues/128">issue #128</a> — issued 2026-08-23 — workspace-dev</summary>

```
/start_dev active/pynufft_removal_downstream_residue_phase_1_developer_break.md
```
...
**154** filed prompts, not started. Each section is sorted most-pickable first (priority, then size). **23** of them belong to an epic and are listed only under [Epics](#epics) below.
...
<details><summary>📋 <a href="draft/maintenance/workspaces/pynufft_removal_downstream_residue_phase_2_workspace_assistant_docs.md">Phase 2: retire pynufft prose from autogalaxy_workspace and both assistants</a> — workspaces · low-medium · supervised · normal</summary>

```
/start_dev draft/maintenance/workspaces/pynufft_removal_downstream_residue_phase_2_workspace_assistant_docs.md
```
...
| 2026-08-23 | filed | <a href="draft/maintenance/workspaces/pynufft_removal_downstream_residue_phase_2_workspace_assistant_docs.md">Phase 2: retire pynufft prose from autogalaxy_workspace and both…</a> |
| 2026-08-23 | issued | <a href="active/pynufft_removal_downstream_residue_phase_1_developer_break.md">Phase 1: fix the pynufft AttributeError breaking all jax_profiling…</a> |
