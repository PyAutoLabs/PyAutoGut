...
<details><summary>📋 <a href="active/run_smoke_per_script_timeout.md">Backport <code>run_smoke.py</code>'s per-script timeout to the three workspace_test siblings</a> — <a href="https://github.com/PyAutoLabs/autogalaxy_workspace_test/issues/108">issue #108</a> — issued 2026-08-23 — workspace-dev</summary>

```
/start_dev active/run_smoke_per_script_timeout.md
```
...
<details><summary>📋 <a href="draft/research/workspaces/intermittent_smoke_hang_jax_mge.md">Intermittent smoke hang on <code>imaging/jax_likelihood/mge.py</code> (autogalaxy_workspace_test)</a> — workspaces · large · supervised · medium</summary>

```
/start_dev draft/research/workspaces/intermittent_smoke_hang_jax_mge.md
```
...
| Date | Event | Task |
|------|-------|------|
| 2026-08-23 | filed | <a href="draft/research/workspaces/intermittent_smoke_hang_jax_mge.md">Intermittent smoke hang on <code>imaging/jax_likelihood/mge.py</code>…</a> |
| 2026-08-23 | issued | <a href="active/run_smoke_per_script_timeout.md">Backport <code>run_smoke.py</code>'s per-script timeout to the three…</a> |
