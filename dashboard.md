...
<details><summary>📋 <a href="draft/maintenance/pyautomind/repos_sync_target_repo_lint_awareness.md">repos_sync.py installs .claude/ into every repo without knowing whether the target lints…</a> — pyautomind · small · supervised · low</summary>
...
| Date | Event | Task |
|------|-------|------|
| 2026-08-25 | filed | <a href="draft/maintenance/pyautomind/repos_sync_target_repo_lint_awareness.md">repos_sync.py installs .claude/ into every repo without knowing…</a> |
