...
| [autofit_sampler_database.md](autofit_sampler_database.md) — ✅ closed 2026-08-21, **0/9 reproduce** on current `main` ([PyAutoFit#1508](https://github.com/PyAutoLabs/PyAutoFit/issues/1508) — no defect; re-validation is automatic, all nine run in every `mode=release` pass). Record: `complete/2026/08/autofit-sampler-database.md` | 9 | Emcee NaNs and database output discovery |
